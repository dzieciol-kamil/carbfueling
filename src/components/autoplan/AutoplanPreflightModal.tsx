...
import { DEFAULT_AUTOPLAN_OPTIONS, type AutoplanOptions, type StopsMode } from './autoplanOptions';
...
// without scrolling the sheet to the bottom — a plain flex sibling below the scroll area rather
// than a `position: sticky` row inside it, so it can't be scrolled past.
