// Printer glyph, shared by the desktop Planning row and the mobile header. Drawn as a compound
// filled path with its interiors cut out (an "outline" icon in the Flaticon sense) rather than
// with `stroke`, so it needs `fill="currentColor"` even though it reads as line art.
