...
export const STR: Record<Lang, StringTable> = {
  pl: {
    ...
    clearPlanButton: 'Wyczyść plan',
    clearPlanConfirmTitle: 'Wyczyścić plan?',
    ...
    clearPlanConfirmConfirm: 'Wyczyść',
  ...
  en: {
    ...
    clearPlanConfirmTitle: 'Clear your plan?',
    clearPlanConfirmBody:
