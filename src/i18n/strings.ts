...
export const STR: Record<Lang, StringTable> = {
  pl: {
    ...
    setupWeightWhere: 'Zmienisz ją później w Ustawieniach.',
  ...
  en: {
    ...
    setupWeightWhere: 'Change it later in Settings.',
  ...
  de: {
    ...
    setupWeightWhere: 'Später änderbar in den Einstellungen.',
  ...
  it: {
    ...
    setupWeightWhere: 'Puoi cambiarlo poi in Impostazioni.',
