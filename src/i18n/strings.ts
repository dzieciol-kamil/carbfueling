...
export const STR: Record<Lang, StringTable> = {
  ...
  en: {
    ...
    autoplanThinkingShared: [
      ...
      'Drew the hard one this time.',
      "Mixing electrolyte in my head. So far it's all dissolved.",
      ...
      "Lunch at halfway or at the finish? Kettle's not boiled yet, one more minute.",
    ...
    autoplanThinkingRunning: [
      ...
      'Nearly done. What every runner says before the last climb.',
  ...
  de: {
    ...
    autoplanThinkingShared: [
      ...
      'Ein Schwieriger ist es geworden.',
      ...
      'Mein Prozessor bittet um Wasser.',
      'Ich umgehe einen Plan mit drei Mittagessen. War verlockend, ich weiß.',
    ...
    autoplanThinkingCycling: [
      ...
      'Ich rechne das so genau, wie du deine Watt zählst.',
    ...
    autoplanThinkingRunning: [
      ...
      'Ich rechne das so genau, wie du dein Tempo pro Kilometer zählst.',
  ...
  it: {
    ...
    autoplanThinkingCycling: [
      ...
      'Conto le soste. Ognuno vorrebbe fermarsi al forno.',
    ],
    autoplanThinkingRunning: [
