  ...
  return (
    <FaqLayout lang="en" slug="heat-carb-plan">
      ...
      <p style={articleTextStyle}>
        ...
        reserves (unless you chase it with a lot of plain water); a well-mixed bottle is already at
        a gentler concentration. And don't forget sodium — sweat rate and sodium loss both climb
        with heat, so your electrolyte needs go up alongside your fluid needs (more on that in{' '}
      ...
      <p style={articleTextStyle}>
        ...
        accordingly, so when you're planning a hot ride, you see both your fluid and carb needs
        together and can adjust your intake instead of guessing.
      </p>
