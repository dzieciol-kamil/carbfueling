    ...
    <div>
      ...
      <header className="landing-header">
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 12 }}>
          ...
          <span style={headerTagline}>Kohlenhydrat- und Flüssigkeitsplaner</span>
        </div>
        <div className="landing-actions">
          <ThemeToggle label={t('de').themeToggleLabel} />
          <LangMenu
            langs={LANGS}
            current="de"
            hrefFor={landingHref}
          ...
          />
          <a href={calculatorHref('de')} style={ctaButton}>
            Rechner öffnen →
          </a>
        </div>
      </header>
      ...
      <main>
        <section className="landing-slide" data-shot="right" data-slide="1">
          ...
          <div className="landing-cluster">
            <h1 className="landing-q">
              Fährst du Rad, läufst du oder machst du <br />
              einen anderen Sport, bei dem du während <br />
              der Belastung Energie nachladen musst?
            </h1>
            <figure className="landing-shot">
              <figcaption className="landing-cap">
                So sieht ein Plan <br />
                für deine Strecke aus
              </figcaption>
              <img
                className="is-light"
                src={assetHref('/landing/hero.jpg')}
                alt="Carb Fueling App: Strecke, Abdeckungskarten und das Diagramm des Fueling-Plans"
              />
              <img
                className="is-dark"
        ...
        <section className="landing-slide" data-shot="left" data-slide="2">
          ...
          <div className="landing-cluster">
            <h2 className="landing-q">
              Saugen Gele und Iso-Getränke leise <br />
              dein Portemonnaie leer, obwohl du <br />
              nicht auf sie verzichten <br />
              willst?
            </h2>
            <figure className="landing-shot">
              <figcaption className="landing-cap">
                Was du brauchst, hast du <br />
                wahrscheinlich schon in der Küche
              </figcaption>
              <img
                className="is-light"
                src={assetHref('/landing/mix.jpg')}
                alt="Mix- und Flaschen-Panel: das Iso-Rezept, abgemessen in Zucker, Salz und Zitrone"
              />
              <img
                className="is-dark"
        ...
        <section className="landing-slide" data-shot="right" data-slide="3">
          ...
          <div className="landing-cluster">
            ...
            <figure className="landing-shot">
              <figcaption className="landing-cap">
                Du siehst die Lücke, bevor sie kritisch wird
              </figcaption>
              <img
                className="is-light"
                src={assetHref('/landing/chart.jpg')}
                alt="Das Plan-Diagramm zeigt die Lücke zwischen aufgenommenen und verbrannten Kohlenhydraten"
              />
              <img
                className="is-dark"
        ...
        <section className="landing-slide" style={{ textAlign: 'center' }} data-slide="4">
          ...
          >
            ...
            >
              <span>Kostenlos</span> · <span>kein Konto</span> · <span>läuft im Browser</span>
            </p>
            <h2
              className="landing-cta-title"
              style={{ fontSize: 28, lineHeight: 1.3, fontWeight: 700, margin: 0 }}
            >
              Plane, wie viele Kohlenhydrate und wie viel Flüssigkeit du auf deine Strecke mitnimmst
              — und wie du sie über die Zeit verteilst.
            </h2>
            <a
              href={calculatorHref('de')}
              style={{
                display: 'inline-flex',
                alignItems: 'center',
                gap: 8,
            ...
            >
              Neugierig, warum das funktioniert? Lies das FAQ →
            </a>
          </div>
        </section>
