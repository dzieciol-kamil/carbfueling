      ...
      <main>
        <section className="landing-slide" data-shot="right" data-slide="1">
          ...
          <div className="landing-cluster">
            <h1 className="landing-q">
              ...
              einen anderen Sport, bei dem du <br />
              während der Belastung <br />
              Energie nachladen musst?
            </h1>
            <figure className="landing-shot">
              <figcaption className="landing-cap">
                Plane, wie viele Kohlenhydrate und wie viel Flüssigkeit du auf deine Strecke
                mitnimmst — und wie du sie über die Zeit verteilst.
              </figcaption>
              <img
                className="is-light"
        ...
        <section className="landing-slide" data-shot="left" data-slide="2">
          ...
          <div className="landing-cluster">
            ...
            <figure className="landing-shot">
              <figcaption className="landing-cap">
                Misch dein Getränk selbst aus dem, was du in der Küche hast — der Planer nennt dir
                das Mischverhältnis.
              </figcaption>
              <img
                className="is-light"
                src={assetHref('/landing/mix.png')}
                alt="Mix- und Flaschen-Panel: das Iso-Rezept, abgemessen in Honig, Salz und Zitrone"
              />
              <img
                className="is-dark"
        ...
        <section className="landing-slide" data-shot="right" data-slide="3">
          ...
          <div className="landing-cluster">
            ...
            <figure className="landing-shot">
              <figcaption className="landing-cap">
                Gib deine Strecke ein und was du mitnimmst — das Diagramm zeigt dir die Lücke, bevor
                sie kritisch wird.
              </figcaption>
              <img
                className="is-light"
        ...
        <section className="landing-slide" style={{ textAlign: 'center' }} data-slide="4">
          ...
          >
            ...
            >
              <span>Kostenlos</span> · <span>kein Konto</span> · <span>keine Cookies</span> ·{' '}
