    ...
    <div>
      ...
      <header className="landing-header">
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 12 }}>
          ...
          <span style={headerTagline}>pianificatore di carboidrati e idratazione</span>
        </div>
        <div className="landing-actions">
          <ThemeToggle label={t('it').themeToggleLabel} />
          <LangMenu
            langs={LANGS}
            current="it"
            hrefFor={landingHref}
      ...
      <main>
        <section className="landing-slide" data-shot="right" data-slide="1">
          ...
          <div className="landing-cluster">
            <h1 className="landing-q">
              Vai in bici, corri o fai un altro <br />
              sport in cui devi rifornirti <br />
              durante lo sforzo?
            </h1>
        ...
        <section className="landing-slide" style={{ textAlign: 'center' }} data-slide="4">
          ...
          >
            ...
            >
              Curioso di sapere perché funziona? Leggi le FAQ →
            </a>
          </div>
        </section>
