...
// so, but the rule holds at every width: just above 760px the desktop bar runs out of room and
// the wordmark, the tagline and the CTA all break onto a second line at once, which puts the
// button's arrow on a line of its own. nowrap here, and the tagline drops below.
    ...
    <div>
      ...
      <header className="landing-header">
        ...
        <div className="landing-actions">
          <ThemeToggle label={t('pl').themeToggleLabel} />
          <LangMenu
            langs={LANGS}
            current="pl"
            hrefFor={landingHref}
      ...
      <main>
        ...
        <section className="landing-slide" data-shot="left" data-slide="2">
          ...
          <div className="landing-cluster">
            ...
            <figure className="landing-shot">
              <figcaption className="landing-cap">
                Zrób własny napój z tego, co masz w kuchni — planer poda proporcje.
              </figcaption>
              <img
                className="is-light"
                src={assetHref('/landing/mix.png')}
                alt="Panel mieszanki: przepis na izotonik i żel odmierzony miodem, solą i cytryną"
              />
              <img
                className="is-dark"
        ...
        <section className="landing-slide" data-shot="right" data-slide="3">
          ...
          <div className="landing-cluster">
            ...
            <figure className="landing-shot">
              <figcaption className="landing-cap">
                Wpisz trasę i to, co zabierasz — wykres pokaże lukę, zanim stanie się krytyczna.
              </figcaption>
              <img
                className="is-light"
        ...
        <section className="landing-slide" style={{ textAlign: 'center' }} data-slide="4">
          ...
          >
            ...
            >
              <span>Za darmo</span> · <span>bez konta</span> · <span>bez cookies</span> ·{' '}
